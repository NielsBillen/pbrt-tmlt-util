 ...
 * @version 0.1
 */
public class BibTexInProceedings extends BibTexEntry {
	/**
	 * Creates a new {@link BibTexInProceedings} with the given citation key.
	 * 
	 * @param citationKey
	 *            citation key for the {@link BibTexInProceedings}.
	 * @throws NullPointerException
	 *             when the given citation key is null.
	 * @throws IllegalArgumentException
	 *             when the citation key is empty.
	 */
	public BibTexInProceedings(String citationKey) throws NullPointerException,
